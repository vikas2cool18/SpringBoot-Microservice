...
public class CargoBookingCommandService {
    ...
    public void assignRouteToCargo(RouteCargoCommand routeCargoCommand){
    	...
    	System.err.println("CargoBookingCommandService.assignRouteToCargo()===========================");
        ...
        if(cargoItinerary.getLegs().size()!=0) {
        	...
        	throw new RuntimeException("Routing Failed as Routing Service is not available !! Try after some time");
        }
